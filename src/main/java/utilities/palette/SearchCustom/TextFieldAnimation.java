...
public class TextFieldAnimation extends JTextField {
    ...
    public TextFieldAnimation() {
        ...
        iconSearch = new ImageIcon(getClass().getResource("\\icons\\Add.png"));
        iconClose = new ImageIcon(getClass().getResource("\\icons\\clo.png"));
        iconLoading = new ImageIcon(getClass().getResource("\\icons\\loa.gif"));
