 ...
 * @author QUOC HUY
 */
public class TPXemDanhSachPhieuNhap extends javax.swing.JPanel {


    public TPXemDanhSachPhieuNhap() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tableAll.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Ngày tạo", "Địa chỉ", "Ghi chú", "Ngày nhận", "Mã nhân viên", "Mã Nhà cung cấp"
            }
        ) {
        ...
        jLabel2.setText("Tìm phiếu nhập theo mã:");
