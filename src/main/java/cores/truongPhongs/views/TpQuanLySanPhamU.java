...
public class TpQuanLySanPhamU extends javax.swing.JFrame {
    ...
    private TpQuanLySanPhamService serviceSP;
    TpQuanLySanPhamCustom tp = new TpQuanLySanPhamCustom();
    ...
    public void showData() {
        this.txtMa.setText(tp.getMa());
        this.txtTen.setText(tp.getTen());
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        if (serviceSP.deleteSanPham(tp.getId())) {
