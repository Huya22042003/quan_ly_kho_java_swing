...
public class TP_CreateNamBaoHangForm extends javax.swing.JFrame {

    private TP_NamBaoHanhService baoHanhService ;
    public TP_CreateNamBaoHangForm() {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if(baoHanhService.addNBH(check) == null) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TP_CreateNamBaoHangForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TP_CreateNamBaoHangForm().setVisible(true);
            }
        });
    }
