 ...
 * @author asus
 */
public class TP_RUDSanPhamForm extends javax.swing.JFrame {

    TP_SanPhamService service ;
    TP_SanPhamCustom custom = new TP_SanPhamCustom();
    public TP_RUDSanPhamForm() {
        initComponents();
    ...
    public TP_RUDSanPhamForm(TP_SanPhamCustom cs) {
        custom = cs;
        service = new TP_SanPhamServiceImpl();
...
//    }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        TpQuanLySanPhamCustom check = service.checkValidate(getFormData(), erroMa, erroTen);
        if (check == null) {
            return;
        }
        TP_SanPhamCustom sp = new TP_SanPhamCustom(custom.getId(), custom.getMa(), check.getTen());
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        if (service.deleteSanPham(custom.getId())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TP_RUDSanPhamForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TP_RUDSanPhamForm().setVisible(true);
            }
        });
    }
