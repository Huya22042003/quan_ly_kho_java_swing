...
public interface TpQuanLyChiTietSanPhamService {
    ...
    List<TpQuanLyChiTietSanPhamCustom> findAllByRadio(int rdo, String tk);
    ...
    TpQuanLyChiTietSanPhamCustom checkValidate(UUID donVi,UUID namBH, UUID sanPham,String hinhAnh,String giaNhap, String giaBan, String soLuong,JLabel erroHinhAnh,JLabel erroGiaNhap, JLabel erroGiaBan, JLabel erroSoLuong );
