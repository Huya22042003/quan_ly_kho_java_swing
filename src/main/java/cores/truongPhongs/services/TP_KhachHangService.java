...
public interface TP_KhachHangService {
    ...
    TP_KhachHangCustom checkValidate(TP_KhachHangCustom kh, JLabel erroMa, JLabel erroTen, JLabel erroSDT, JLabel erroEmail, JLabel erroMatKhau, JLabel erroDiaChi, JLabel erroDanhGia );
    KhachHangConstant loc(int a);
    TP_KhachHangCustom findKHByMa(String ma);
    List<TP_KhachHangCustom> findAllByRadio(String ten, CoSoConstant tt, int rdo);
}
