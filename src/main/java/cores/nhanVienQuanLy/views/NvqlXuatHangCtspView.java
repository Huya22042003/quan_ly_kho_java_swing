 ...
 * @author QUOC HUY
 */
public class NvqlXuatHangCtspView extends javax.swing.JFrame {
    ...
    public NvqlXuatHangCtspView(DemoCoSoCustom cs) {
        csc = cs;
        coSoService = new DemoCoSoServiceImpl();
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NvqlXuatHangCtspView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NvqlXuatHangCtspView().setVisible(true);
            }
        });
    }
