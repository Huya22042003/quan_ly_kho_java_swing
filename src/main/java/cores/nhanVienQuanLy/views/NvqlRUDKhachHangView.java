 ...
 * @author QUOC HUY
 */
public class NvqlRUDKhachHangView extends javax.swing.JFrame {
    ...
    public NvqlRUDKhachHangView(DemoCoSoCustom cs) {
        csc = cs;
        coSoService = new DemoCoSoServiceImpl();
        initComponents();
        coSoService.loadCombobox(cbbTrangThai);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NvqlRUDKhachHangView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NvqlRUDKhachHangView().setVisible(true);
            }
        });
    }
