    ...
    private void init() {
        ...
        menu.addEventShowPopup(new EventShowPopupMenu() {
            ...
            public void showPopup(Component com) {
                ...
                PopupMenu popup = new PopupMenu(KhachHang.this, item.getIndex(), item.getEventSelected(), item.getMenu().getSubMenu());
                int x = KhachHang.this.getX() + 52;
                int y = KhachHang.this.getY() + com.getY() + 86;
