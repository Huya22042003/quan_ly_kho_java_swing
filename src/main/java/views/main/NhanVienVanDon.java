 ...
 * @author QUOC HUY
 */
public class NhanVienVanDon extends javax.swing.JFrame {
    ...
    private void init() {
        ...
        menu.addEventShowPopup(new EventShowPopupMenu() {
            ...
            public void showPopup(Component com) {
                ...
                PopupMenu popup = new PopupMenu(NhanVienVanDon.this, item.getIndex(), item.getEventSelected(), item.getMenu().getSubMenu());
                int x = NhanVienVanDon.this.getX() + 52;
                int y = NhanVienVanDon.this.getY() + com.getY() + 86;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NhanVienVanDon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NhanVienVanDon().setVisible(true);
            }
        });
    }
