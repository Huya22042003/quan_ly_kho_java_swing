...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/icons/eye_hide.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/icons/eye.png")).getImage();
